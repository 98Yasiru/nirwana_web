    ...
    <section style="height: 100%;margin-top: -10%;">
        <div class="container" style="height: 100%;margin-top: 8%;padding-bottom: 8%;color: rgb(10,10,10);max-width: 100%;width: 100%;">
            <div class="photo-card" style="height: 100%;background: rgba(45,54,56,0);max-width: 100%;padding-right: 3%;">
                <div class="photo-background" style="background: url(&quot;assets/img/ayurvedic-medicine-removebg-preview.png&quot;) center / contain no-repeat, rgba(255,255,255,0);margin-right: 5%;"></div>
                <div class="photo-details" style="background: linear-gradient(-8deg, rgba(255,255,255,0.58) 0%, rgba(0,0,0,0) 100%), url(&quot;assets/img/logo.png&quot;) center / contain no-repeat, rgba(255,255,255,0.19);border-style: solid;border-color: rgb(255,255,255);border-radius: 40px;margin-left: 5%;color: rgb(255,253,253);">
                    <h1 style="color: rgb(0,0,0);"><strong><span style="text-decoration: underline;">Toothache.&nbsp;&nbsp;දත්කැක්කුම.</span></strong></h1>
                    <p class="fs-6" style="color: rgb(0,0,0);background: rgba(255,255,255,0);">සීනක්කාරං පුඵස්සා කුඩුකර බෝතලයක&nbsp;දමා වතුර පුරවා තබාගෙන නිතර සොලවා&nbsp;කට සෝදන්න.<br><br>කටුකරඞු,සමන්පිච්ච කොළ,කරඳ මුලේ&nbsp;පොතු කළං 6 බැගින් ගෙන කයිප්පු, සීනක්කාරං,රත් හඳුන් කළං 3 බැගින් දමා&nbsp;වතුර පත 16 පත 4 ට සිඳුවා දිනකට 3 වරක්&nbsp;<br>වරකට විනාඩි 5 ක් වතුර කටට ගෙන කකාරා කට සෝදා හරින්න.<br><br>වියළි ඉගුරු,ගම්මිරිස්,පිලමුල් පොතු,දියලුණු&nbsp;සමව ගෙන දෙහි ඇඹුලෙන් අඹරා දත මුල&nbsp;තබන්න.</p>
                </div>
            </div>
        </div>
    </section>
