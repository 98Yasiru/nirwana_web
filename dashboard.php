...
<body style="background: #7CBCBC;">
    ...
    </nav><img class="img-fluid d-none d-print-inline d-lg-inline d-xl-inline d-xxl-inline" src="assets/img/home.png" width="50%" style="/*margin-bottom: 13px;*//*margin-right: 25px;*//*margin-top: 15px;*//*padding-right: 3px;*/float: left;">
    <div class="fs-3 text-center"><img src="assets/img/textlogo.png" width="200" height="203">
        <p class="font-monospace text-center" style="/*float: right;*/font-family: ABeeZee, sans-serif;text-align: left;">The main objective is to contribute to the&nbsp;<br>quality development of the field of Ayurveda&nbsp;<br>by providing maximum service in accordance&nbsp;<br>with professional ethics.</p>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-lg-8 mx-auto">
                        ...
                        <h4 style="color: rgb(0,0,0);"><i class="typcn typcn-mail"></i>&nbsp;Nirwanaofficial@gmail.com</h4>
                        <h4 style="color: rgb(0,0,0);"><i class="fa fa-phone"></i>&nbsp;+94 41 22 22 990 / +94 11 44 44 990</h4>
                    </div>
                </div>
            </div>
        </footer>
