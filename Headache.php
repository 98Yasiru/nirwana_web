    ...
    <section style="height: 100%;">
        <div class="container" style="height: 100%;margin-top: 8%;padding-bottom: 8%;color: rgb(10,10,10);max-width: 100%;width: 100%;">
            <div class="photo-card" style="height: 100%;background: rgba(45,54,56,0);max-width: 100%;padding-right: 3%;">
                <div class="photo-background" style="background: url(&quot;assets/img/ayurvedic-1296x728-header-removebg-preview.png&quot;) center / contain no-repeat, rgba(255,255,255,0);margin-right: 5%;"></div>
                <div class="photo-details" style="background: linear-gradient(-8deg, rgba(255,255,255,0.58) 0%, rgba(0,0,0,0) 100%), url(&quot;assets/img/logo.png&quot;) center / contain no-repeat, rgba(255,255,255,0.19);border-style: solid;border-color: rgb(255,255,255);border-radius: 40px;margin-left: 5%;color: rgb(255,253,253);margin-top: -10%;">
                    <h1 style="color: rgb(0,0,0);"><strong><span style="text-decoration: underline;">Headache.&nbsp;&nbsp;හිසරදය.</span></strong></h1>
                    <p class="fs-6 text-start" style="color: rgb(0,0,0);background: rgba(255,255,255,0);">අමු ඉගුරු, කොත්තමල්ලි,පත්පාඩගම්,&nbsp;<br>කටුවැල්බටු,දේවදාර කළං දෙකයි. මදටිය&nbsp;<br>8 බැගින් ගෙන වතුර පත 8-1 සිඳ සහිඳ ලුණු&nbsp;<br>අනුපානය කොට උදේ සවස පත භාගය&nbsp;<br>බැගින් බොන්න.(වඩි 3 පමණ).<br><br>අමු ඉගුරු,කටුවැල්,බටු තිප්පිලි,සුවඳ&nbsp;<br>කොට්ටන් කළං 3 බැගින් ගෙන වතුර පත&nbsp;<br>8-1ට සිඳ උදේ සවස සීනි දමා වඩි කීපයක්&nbsp;<br>බොන්න.<br><br>තිප්පිලි කළං 1 යි, අමු ඉගුරු කළං 2යි, බැදපු&nbsp;කොත්තමල්ලි කළං 3 යි, වතුර පත 8-4 සිඳුවා<br><br> වී පොරි කළං 6 ක් දමා පත එකට සිඳුවා සහිඳ&nbsp;ලුණු කළඳක් දමා උදේ හිස්බඩ එකවර පතම&nbsp;බොන්න.<br><br></p>
                </div>
            </div>
        </div>
    </section>
