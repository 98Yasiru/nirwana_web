        ...
        <div class="container" style="height: 100%;padding-bottom: 8%;color: rgb(10,10,10);max-width: 100%;width: 100%;">
            <div class="photo-card" style="height: 100%;background: rgba(45,54,56,0);max-width: 100%;/*padding-right: 3%;*/">
                ...
                <div class="photo-details" style="background: linear-gradient(-8deg, rgba(255,255,255,0.58) 0%, rgba(0,0,0,0) 100%), url(&quot;assets/img/logo.png&quot;) center / contain no-repeat, rgba(255,255,255,0.19);border-style: solid;border-color: rgb(255,255,255);border-radius: 40px;margin-left: 5%;color: rgb(255,253,253);">
                    <h1 style="color: rgb(0,0,0);"><strong><span style="text-decoration: underline;">Synonyms.&nbsp;&nbsp;උෂ්ණ රෝග.</span></strong></h1>
                    <p class="fs-6" style="color: rgb(0,0,0);background: rgba(255,255,255,0);">ඇත්තෝර දඵ,බේත් එඞරු දඵ,කුකුරුමාං&nbsp;<br>දඵ,කොහොඹ දඵ,දෙහි ඇට මද කොටා&nbsp;<br>පොට්ටනි බැඳ වණ්ඩුවේ තම්බා උදේ සවස&nbsp;<br>හොඳින් තවන්න.<br><br>ඇත්තෝර කොළ,දෙහි ඇට මද,සුදු ඵෑණු&nbsp;<br>සමව ගෙන දෙහි ඇඹුලෙන් අඹරා බඳින්න.&nbsp;<br>ලුනුවිල තැම්බු වතුරෙන් හෝ කොහොඹ&nbsp;<br>දඵ,අමුකහ තැම්බු වතුරෙන් හෝ සෝදන්න.<br><br>නිදිකුම්බා,සමදරා කොළ තම්බා සෝදා&nbsp;<br>හුණු,කපුරු,කහ සමව ගෙන පිරිසිදු තැඹිලි&nbsp;<br>තෙලින් අඹරා ගාන්න.</p>
                </div>
            </div>
        </div>
    </section>
